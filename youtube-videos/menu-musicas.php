...
.horizontal-menu a.active {
    ...
    <div class="col-md-2"> <!-- terceira coluna -->
	    <p> <p>
        <div class="vertical-menu">
            <ol> 
                <li class="active"> <a href="alejandrosans.php" id="alejandrosans"> Alejandro Sans </a> </li>	
                ...
                <li> <a href="capitalinicial.php" id="capitalinicial">Dinho / Capital Inicial</a> </li>
                ...
                <li> <a href="joejonas.php" id="joejonas"> Joe Jonas / Brothers</a> </li>				
                <li> <a href="nickjonas.php" id="nickjonas"> Nick Jonas / Brothers </a> </li>
				...
				<li> <a href="legiaourbana.php" id="legiaourbana"> RenatoRusso/LegiãoUrbana </a> </li>	
				...
				<li> <a href="zezedicamargoluciano.php" id="zezedicamagoluciano"> Zezé DiCamargo & Luciano</a> </li>				
            </ol> 
        </div> 
    </div>
	 ...
	 <p> <p>
        <div class="vertical-menu">
            <ol> <b>
			    ...
			    <li> <a href="anitta.php" id="anitta"> Anitta </a> </li>
                ...
                <li> <a href="joelmabandacalypso.php" id="joelmabandacalypso"> Joelma / Banda Calypso </a> </li>					
				<li> <a href="beyonce.php" id="beyonce"> Beyoncé </a> </li>
                ...
                <li> <a href="ivetesangalo.php" id="ivetesangalo"> Ivete Sangalo </a> </li>	
                <li> <a href="iza.php" id="iza"> Iza </a> </li>							
                <li> <a href="jenniferlopez.php" id="jenniferlopez"> Jennifer Lopez </a> </li>
                ...
                <li> <a href="maiaraemaraisa.php" id="maiaraemaraisa"> Maiara & Maraisa </a> </li>					
                ...
                <li> <a href="paulatoller.php" id="paulatoller"> Paula Toller / Kid Abelha </a> </li>
                ...
                <li> <a href="simonesimara.php" id="simonesimara"> Simone & Simara </a> </li>
